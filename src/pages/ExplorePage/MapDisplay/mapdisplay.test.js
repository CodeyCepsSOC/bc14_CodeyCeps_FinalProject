...
test('renders routes correctly on the map', () => {

   
    render(<MapDisplay routeDetailArray={routeDetailArray} activeRoute={0} prevRoutes={[]}/>);
    

    expect(screen.getByTestId('map-container')).toBeInTheDocument();
    expect(screen.getByTestId('map-container')).toHaveAttribute('ref');

    expect(screen.getByText('Hildas Walk')).toBeInTheDocument();
    expect(screen.getByText('Isaacs Walk')).toBeInTheDocument();
    expect(screen.getByText('Samis Walk')).toBeInTheDocument();
});
